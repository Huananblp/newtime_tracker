...
const CONFIG = {
  ...
  TELEGRAM: {
    ...
    // 🆕 HR Telegram channel สำหรับรายงาน "ลืมออกงาน"
    HR_BOT_TOKEN: process.env.HR_TELEGRAM_BOT_TOKEN || process.env.TELEGRAM_BOT_TOKEN,
    HR_CHAT_ID: process.env.HR_TELEGRAM_CHAT_ID || process.env.TELEGRAM_CHAT_ID
  },
  LINE: {
