...
const CONFIG = {
  ...
  TELEGRAM: {
    ...
    // 🆕 การแจ้งเตือนระบบ (ลืมลงเวลาออก, ข้อผิดพลาด)
    SYSTEM_ALERT: {
      ENABLED: process.env.TELEGRAM_SYSTEM_ALERT_ENABLED === 'true',
      BOT_TOKEN: process.env.TELEGRAM_SYSTEM_ALERT_BOT_TOKEN || process.env.TELEGRAM_BOT_TOKEN,
      CHAT_ID: process.env.TELEGRAM_SYSTEM_ALERT_CHAT_ID || process.env.TELEGRAM_CHAT_ID
    }
  },
  LINE: {
